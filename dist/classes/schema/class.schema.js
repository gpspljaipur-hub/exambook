...
exports.ClassSchema = exports.ClassModel = void 0;
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
let ClassModel = class ClassModel {
};
exports.ClassModel = ClassModel;
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", String)
], ClassModel.prototype, "name", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose_2.Types.ObjectId, ref: "Board", required: true }),
    __metadata("design:type", mongoose_2.Types.ObjectId)
], ClassModel.prototype, "boardId", void 0);
exports.ClassModel = ClassModel = __decorate([
